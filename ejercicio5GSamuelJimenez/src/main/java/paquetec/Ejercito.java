...
public class Ejercito {
    ...
    public String alistarSoldado(Soldado s) {
        ...
        String resultado = this.listaEfectivos.add(s) ? "El soldado " + s.getNombre() + " ha sido alistado" : "¡ERROR! - El soldado " + s.getNombre() + " ya estaba en el sistema";
        return resultado;
